...
//	Mat F;  //基础矩阵
//
//	stereoCalibrate(object_points1, image_points_seq1, image_points_seq2, cameraMatrix1, distCoeffs1, cameraMatrix2, distCoeffs2, image_size, R, T, E, F, CALIB_USE_INTRINSIC_GUESS, TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, 1e-5));
...
//	}
//		
//	imwrite("rectified1.png", canvasPart1);
//    imwrite("rectified2.png", canvasPart2);
